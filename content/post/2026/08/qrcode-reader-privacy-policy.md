...
=====================================================================
  ...
  【要記入】連絡先メールアドレス
    本文中の {{連絡先メールアドレス}} を実際に公開するアドレスに置き換える。
    「データ削除のリクエスト」と「お問い合わせ」の 2 箇所に出現。
    Google Play のデータセーフティ申告にも同じ窓口を記載する想定。
...
上記の第三者提供 SDK が収集した情報について削除をご希望の場合は、以下の窓口までご連絡ください。ご連絡の際は、お使いの端末の機種名と、削除をご希望の内容をお知らせください。
